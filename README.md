...
This error happens in Google's web-app gateway before B-RIG code runs, so the application cannot detect or replace it with a custom error message. Ask the student to use either supported workaround:
